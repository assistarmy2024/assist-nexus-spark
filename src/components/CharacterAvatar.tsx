  ...
  return (
    ...
    >
      <div className="relative">
        {/* Subtle glow effect with no movement */}
        <div className={cn(
          "absolute -inset-2 rounded-full blur-md opacity-30 bg-gradient-to-br",
        ...
        <div className={cn(
          ...
          size === 'lg' ? 'w-32 h-32' : 
          'w-40 h-40',
          'border-2 shadow-lg transition-opacity duration-300',
          normalizedCharacter === 'children' ? 'border-blue-500 shadow-blue-500/20 bg-gradient-to-br from-blue-500/20 to-indigo-500/20' : 
          normalizedCharacter === 'elderly' ? 'border-teal-500 shadow-teal-500/20 bg-gradient-to-br from-teal-500/20 to-blue-500/20' : 
          'border-indigo-500 shadow-indigo-500/20 bg-gradient-to-br from-indigo-500/20 to-purple-500/20'
        )}>
          <div className={cn(
