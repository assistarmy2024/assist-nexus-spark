...
import { Sparkles, MessageSquare, Video, Home, Lightbulb, BrainCog } from 'lucide-react';
    ...
    <Sheet>
      ...
      <SheetContent side="left" className="bg-[#121a3a] border-r border-white/10 w-[300px]">
        ...
        <nav className="mt-8 space-y-4">
          <NavItem icon={<BrainCog className="w-5 h-5" />} label="KidBot" onClick={() => navigate('/child')} />
          <NavItem icon={<Lightbulb className="w-5 h-5" />} label="ElderAssist" onClick={() => navigate('/elderly')} />
