          ...
          <div className="mb-6">
            <div className="relative">
              <input 
                ...
                className="w-full bg-white/5 border border-indigo-500/20 rounded-full px-5 py-3 pr-12 text-white outline-none focus:ring-2 focus:ring-indigo-500/50 shadow-inner"
                value={inputValue}
            ...
            <GlassCard className="p-5 bg-gradient-to-br from-[#1F1346]/90 to-[#22143B]/90 border border-indigo-500/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 rounded-lg bg-gradient-to-br from-indigo-900/30 to-purple-900/30 hover:from-indigo-900/40 hover:to-purple-900/40 cursor-pointer transition-colors">
                  ...
                  <p className="text-gray-300 text-sm">Schedule your high-energy appliances to run during off-peak hours to save on your electric bill.</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-gradient-to-br from-violet-900/30 to-indigo-900/30 hover:from-violet-900/40 hover:to-indigo-900/40 cursor-pointer transition-colors">
                  ...
                  <p className="text-gray-300 text-sm">I've suggested 3 new recipes using ingredients you already have in your refrigerator.</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-gradient-to-br from-fuchsia-900/30 to-pink-900/30 hover:from-fuchsia-900/40 hover:to-pink-900/40 cursor-pointer transition-colors">
                  ...
                  <p className="text-gray-300 text-sm">Your HVAC filter is due for replacement. I can order one for delivery or add it to your list.</p>
                </div>
              </div>
            </GlassCard>
          </div>
          ...
          <div className="mb-6">
            <GlassCard className="p-5 bg-gradient-to-br from-[#1F1346]/90 to-[#22143B]/90 border border-indigo-500/20">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <button className="flex flex-col items-center p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-colors"
          ...
          <GlassCard className="p-4 bg-gradient-to-br from-[#1F1346]/90 to-[#22143B]/90 border border-indigo-500/20">
            <div className="relative">
              <input 
                ...
                className="w-full bg-black/20 border border-indigo-500/30 rounded-full px-5 py-3 pr-12 text-white outline-none focus:ring-2 focus:ring-indigo-500/50"
                onKeyPress={(e) => {
                  if (e.key === 'Enter') {
                    setShowLiveInteraction(true);
                  }
