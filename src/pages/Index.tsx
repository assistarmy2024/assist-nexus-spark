      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <GlassCard className="h-full">
              <div className="flex flex-col items-center justify-center h-full">
                <div className="relative flex flex-col items-center p-6 bg-gradient-to-br from-[#132B2B]/80 to-[#003636]/90 backdrop-blur-md rounded-2xl border border-teal-500/20 shadow-[0_8px_16px_rgba(0,0,0,0.4)] transition-all duration-300 group-hover:translate-y-[-4px] group-hover:shadow-teal-400/20 cursor-pointer h-full">
          ...
          >
            <GlassCard className="h-full">
              <div className="flex flex-col items-center justify-center h-full">
                <div className="relative flex flex-col items-center p-6 bg-gradient-to-br from-[#311147]/80 to-[#4B0942]/90 backdrop-blur-md rounded-2xl border border-pink-500/20 shadow-[0_8px_16px_rgba(0,0,0,0.4)] transition-all duration-300 group-hover:translate-y-[-4px] group-hover:shadow-pink-400/20 cursor-pointer h-full">
